...
public class DiscussfufeidianyingController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussfufeidianyingEntity discussfufeidianying, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussfufeidianyingEntity discussfufeidianying, HttpServletRequest request){
        EntityWrapper<DiscussfufeidianyingEntity> ew = new EntityWrapper<DiscussfufeidianyingEntity>();
		PageUtils page = discussfufeidianyingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussfufeidianying), params), params));
        return R.ok().put("data", page);
    }
