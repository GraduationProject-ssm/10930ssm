...
public class FufeidianyingController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,FufeidianyingEntity fufeidianying, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,FufeidianyingEntity fufeidianying, HttpServletRequest request){
        EntityWrapper<FufeidianyingEntity> ew = new EntityWrapper<FufeidianyingEntity>();
		PageUtils page = fufeidianyingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, fufeidianying), params), params));
        return R.ok().put("data", page);
    }
